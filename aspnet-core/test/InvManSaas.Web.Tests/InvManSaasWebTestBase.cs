...
{
    public abstract class InvManSaasWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InvManSaasWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InvManSaasWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<InvManSaasDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<InvManSaasDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InvManSaasDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InvManSaasDbContext, Task<T>> func)
        {
            T result;
